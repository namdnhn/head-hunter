<template>
    <section class="fixed top-0 left-0 right-0 h-full z-50 bg-lime-50 flex items-center justify-center">
                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        ...
                        <div class="form-control">
                            ...
                            <input type="email" name="email" id="email"
                                ...
                                placeholder="email@company.com" v-model="emailCandicate.value" />
                        </div>
                        <!-- password  -->
                        <div>
                            ...
                            <input type="password" name="password" id="password" placeholder="••••••••"
                                ...
                                v-model="passwordCandicate.value" @input="checkKeyDown" />
                        </div>
                        <div>
                            <!-- <label v-if="checkKeyDown()"></label> -->
                            <label class="block mb-2 text-sm font-medium text-red-500" v-if="!passwordCandicate.isValid">Mật
                                khẩu của bạn quá ngắn, hãy nhập lại mật
                                khẩu !</label>
                        </div>
                        <!-- <div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="remember" aria-describedby="remember" v-model="rememberPasswordCandicate.value
                                        " type="checkbox"
                        ...
                        <p class="text-sm font-light text-cyan-800">
                            ...
                            <a href="#" class="font-bold text-primary-600 hover:underline dark:text-primary-500">
                                <router-link to="./registerCandidatePage">Đăng ký ngay !</router-link>
                            </a>
                        </p>
                    </form>
                </div>
        ...
        <base-dialog :show="!!error" title="Đăng nhập thất bại!" @close="handleError">
