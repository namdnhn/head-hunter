<template>
	...
	>
		...
		>
			...
			>
				Trang đăng nhập này dành riêng cho nhân viên của các công ty
				tuyển dụng
			</a>
			<div
					...
					<form class="space-y-4 md:space-y-6" action="#">
						<div>
							...
							<input
								...
								required="true"
								v-model="emailCompanyName.value"
							/>
						</div>
						<div>
							<label
						...
						<p class="text-sm font-light text-cyan-800">
							...
							>
								<router-link to="./registerEmployeePage"
